...
<div style="display:flex; gap:28px; align-items:flex-start; margin:25px 0 35px 0;">
  ...
  <div style="flex:1; min-width:0;">
    ...
    <p>
      <strong>Pranav Unnikrishnan</strong>, Anna Spaeth, Magdalena Trojańska,
      Wiesław Babik, Agata Plesnar-Bielak
    </p>
    ...
    <p>
      Experimental evolution study investigating how temperature and sexual-selection regime interact to influence 6Pgdh allele-frequency dynamics in bulb mites.
    </p>
...
<div style="display:flex; gap:28px; align-items:flex-start; margin:25px 0 35px 0;">
  ...
  <div style="flex:1; min-width:0;">
    ...
    <p>
      <strong>Pranav Unnikrishnan</strong>, Szymon Grzesik, Magdalena Trojańska,
      Beata Klimek & Agata Plesnar-Bielak
    </p>

    <p>
      <em>Experimental and Applied Acarology</em>
    </p>

    <p>
      Field study examining the prevalence of 6Pgdh polymorphism across natural bulb mite populations and its associations with environmental variation.
    </p>
...
@media (max-width: 650px) {
  ...
  .page__content div[style*="flex:0 0 180px"] {
    width: 160px;
  }
}
</style>
