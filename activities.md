---
title: "Activities & Collaborations"
layout: single
...
<div class="activity-section">
  ...
  <div class="two-column">
    <div class="left">
      <img src="/assets/images/activities/organizers.jpg" alt="EMPSEB29 Organising Committee">
      <p class="caption small-caption">
        From left to right: Alaa Hseiky (Jagiellonian University, Poland), Florian Strahodinsky (Institute of Science and Technology Austria), 
        Nhu L.T. Tran (University of Cologne, Germany), Pranav Unnikrishnan (Jagiellonian University, Poland), 
        Gulsamal Askarova (Adam Mickiewicz University, Poland), and Alan Flatrès (University of Western Ontario, Canada).
      </p>
    </div>
...
<div class="right">
  ...
  <h2>Collaboration with Sponsors</h2>
...
<div class="activity-section">
  ...
  <p class="caption small-caption">
    Group photo from the <strong>9th Polish Evolutionary Conference (PEC 2023)</strong> held in Kraków, Poland.
  </p>
</div>
...
<div class="activity-section alt">
  ...
  <p class="caption small-caption">
    Group photo from the <strong>Experimental Evolution Course 2022</strong> held at the University of Veterinary Medicine, Vienna.
  </p>
</div>
...
<div class="activity-section">
  <h1>University Fest — Lead Organizer</h1>
...
/* Cards, boxes, and backgrounds */
.design-section, .activity-section, .cv-section {
  background-color: #0d1117 !important;
  color: #e6e6e6 !important;
  border-top: 1px solid #1f2933 !important;
}

/* Alternating light panels (optional) */
.design-section.alt, .activity-section.alt, .cv-section.alt {
...
.masthead__menu-item a:hover {
  color: #3db2e1 !important;
}

/* Author bio cards, avatars, and images */
.author__avatar img {
